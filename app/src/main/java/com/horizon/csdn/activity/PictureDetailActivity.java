...
import com.horizon.csdn.util.DisplayUtils;
import com.horizon.csdn.util.SimpleAnimatorListener;
...
public class PictureDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File file = diskCache.get(smallPicInfo.data);
    ...
    private void loadOnNetwork(){
        ...
        ivDetail.animate().translationX(0).translationY(0).setDuration(DURATION).setListener(new SimpleAnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Application.getInstance().getImageLoader().displayImage(smallPicInfo.data, ivDetail, options, new SimpleImageLoadingListener() {
